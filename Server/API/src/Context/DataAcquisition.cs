...
namespace Context
{
    public class DataAcquistion
    {
        ...
        private async Task StartDriver(Drivers driver)
        {
            await driver.Create();
        ...
        private async Task DeactivateFormer(String dp, AlarmType alarmType)
        {
            ...
            if (alarme != null)
            {
                ...
                await MongoUoW.AlarmList.InsertOrUpdateOneAsync(alarme);
            }
        }
        ...
        private async Task Fire(DataPoint dp, AlarmThreshold th)
        {
            ...
            entry.DataPoint = dp;
            await MongoUoW.AlarmList.InsertOrUpdateOneAsync(entry);
        }
